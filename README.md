...
```
▸  Building full stack SaaS web applications using React, Node.js & MongoDB
▸  Delivering client websites at MileTap & RojrzTech — international remote clients
▸  Deepening expertise in TypeScript, testing & backend architecture
```
...
Styling   //  Tailwind CSS · Ant Design · Bootstrap
State     //  Redux Toolkit · RTK Query
Backend   //  Node.js · Express.js · MongoDB · REST APIs
Tools     //  Git · Figma · Vercel · WordPress
```
...
| ⚡ Performance first | 🧩 Reusable systems | 🤝 Client-focused | 🌍 Remote-ready |
|---|---|---|---|
| Every project optimized for speed. Lighthouse 90+ is baseline | Build component libraries that scale — not one-off solutions | Translated 50+ client briefs into clean, maintainable code | Experienced with async workflows & international clients |
...
[linkedin.com/in/yasirweb](https://linkedin.com/in/yasirweb) &nbsp;·&nbsp; [yasir-portfolio-nextjs.vercel.app](https://yasir-portfolio-nextjs.vercel.app) &nbsp;·&nbsp; [muhammad.yasir1368@gmail.com](mailto:muhammad.yasir1368@gmail.com)
